...
class CmsTest < Minitest::Test
  ...
  def test_document_not_found
    get "/notexistfile.txt"

    assert_equal 302, last_response.status
    assert_equal "notexistfile.txt does not exist.", session[:message]
  end
  ...
  def test_editing_document_sign_out
    create_document "changes.txt"
  ...
  def test_updating_document_signe_out
